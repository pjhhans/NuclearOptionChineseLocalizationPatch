...
**目前所有译文均由 AI 翻译＋人工审核，作者正在实际游玩中逐批校对和修正。**
...
> *本插件会改写游戏「读回」的文本，这在联机路径上可能出现无法预见的行为。*
...
- **报告漏翻**：按F11开启控制台，开启累积漏译到 missing.json / untranslated.json，然后把 `missing.json` / `untranslated.json` 附上。
